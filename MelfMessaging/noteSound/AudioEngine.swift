...
class AudioEngine {
    ...
    var recordedFileURL = URL(fileURLWithPath: "input.caf", isDirectory: false, relativeTo: URL(fileURLWithPath: NSTemporaryDirectory()))
    ...
    // 录音状态
    var statusOfRecording = 0 // 0:录制，1：暂停，2，停止
